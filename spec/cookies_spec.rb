...
describe Horseman::Cookies do
  ...
  it "should accept a single header" do
    subject.update(simple_header)['name1'].should eq 'value1' 
  end
  
  it "should accept multiple headers" do
  ...
  it "should raise an exception on an unrecognized header" do
  ...
  context "with prexisting values" do
    ...
    it "should return nil for uninitialized values" do
      subject['doesnt_exist'].should be_nil
    end
    
    it "should merge new values" do
      subject.update(complex_header)
